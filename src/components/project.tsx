...
function ProjectItem({ project }: { project: (typeof projectsData)[number] }) {
  ...
  return (
    ...
    >
      <section className=" border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-50 transition sm:group-even:pl-8 shadow-lg">
