...
const Education: React.FC = () => {
  return (
    <div id="education" className="relative max-w-7xl mx-auto px-4 py-5">
      <div className="absolute max-lg:left-0 max-lg:translate-x-[60px] lg:left-1/2 transform -translate-x-1/2 w-1 h-[500px] bg-gray-300"></div>
...
const TimelineItem: React.FC<{ item: TimelineItemType; index: number }> = ({
  ...
  return (
    ...
    >
      <motion.div
        className="z-20 flex lg:hidden items-center justify-center bg-blue-500 shadow-xl w-14 h-14 rounded-full mx-4 flex-shrink-0"
      ...
      <div className="w-full lg:w-5/12">
        <motion.div
          ...
          transition={{ type: "spring", stiffness: 300 }}
        >
          <h3 className="mb-3 font-bold text-gray-800 text-md">{item.title}</h3>
      ...
      <motion.div
        className="z-20 flex items-center max-lg:hidden justify-center bg-blue-500 shadow-xl w-16 h-16 rounded-full mx-4 flex-shrink-0"
        whileHover={{ scale: 1.2, rotate: 360 }}
        transition={{ type: "spring", stiffness: 300 }}
      >
